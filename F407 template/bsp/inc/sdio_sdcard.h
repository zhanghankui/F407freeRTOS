...
SD_Error SD_ReadDisk(uint8_t*readbuff,uint64_t ReadAddr,uint32_t NumberOfBlocks); 	//读SD卡,fatfs/usb调用
SD_Error SD_WriteDisk(uint8_t*writebuff,uint64_t WriteAddr,uint32_t NumberOfBlocks);	//写SD卡,fatfs/usb调用
