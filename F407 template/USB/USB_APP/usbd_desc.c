...
__ALIGN_BEGIN uint8_t USBD_DeviceDesc[USB_SIZ_DEVICE_DESC] __ALIGN_END =
  {
    ...
    0x02,		
#endif		
//USB所遵循的标准设备类。0表示设备的接口相互独立，分别属于不同的设备类,设备类信息定义在接口描述符中；
         //1~FEH之间表示USB协议中定义的某个类。03H表示HID类，02H表示CDC类，01表示音频设备，08表示大容量存储。		
